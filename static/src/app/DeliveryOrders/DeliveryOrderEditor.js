...
export class DeliverOrderEdit extends Component {
    static template = "point_of_sale.DeliveryOrderEdit";
    // setup() {
    //     this.popup = useService("popup");
    //     this.pos = usePos();
    //     const order = this.props.order;
    //     console.log("OrderEdit props: ", this.props);
    //     console.log("OrderEdit order: ", this.props.order);
    //     this.changes = useState({
    //         zmall_order_id: order.zmall_order_id || "",
    //         store_id: order.store_id || "",
    //         unique_id: order.unique_id || "",
    //         created_at: order.created_at || "",
    //         order_status: order.order_status || "",
    //         customer_name: order.customer_name || "",
    //         total_cart_price: order.total_cart_price || "",
    ...
    //     }
    //     processedChanges.id = this.props.order.id || false;
...
//         const order = this.props.order;
//         console.log("DeliveryOrderEdit props: ", this.props);
//         console.log("deliveryOrderEdit order: ", this.props.order);
//         this.changes = useState({
//             name: partner.name || "",
